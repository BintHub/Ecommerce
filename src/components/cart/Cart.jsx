...
const Cart = () => {
  ...
  return (
     ...
     <div className='relative max-w-[full] min-h-[316px] '>
      ...
      {/* overlay */}
       <div className='absolute max-w-full min-h-1/4 top-0 left-0 mt-6 ml-60
        sm:ml-60 sm:mt-10 md:ml-80 lg:ml-[36rem] lg:mt-[6rem]'>
         <div>
    ...
    <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 sm:-mt-40 md:-mt-24 md:ml-10 lg:mt-0 lg:ml-32'>
       <div className='max-w-[100%] mt-10  sm:mr-14 md:w-[50%] lg:w-[100%] '>
       <table className='w-[100%] min-h-[20vh] ml-10 md:-ml-8 '>
       ...
       <tbody>
         <tr className='text-[#9F9F9F] font-poppins font-normal text-base'>
           <td className='flex gap-4 md:flex-col lg:flex-row'> <Image  loading='lazy' cloudName="ddml48ptj8" 
      publicId= "https://res.cloudinary.com/dml48ptj8/image/upload/v1726808194/Asgaard_sofa_5_mt607l.png">
           ...
           <td><img  className='px-1' src={del} alt="icon" /> </td>
         </tr>
         </tbody>
         </table>
       </div>
